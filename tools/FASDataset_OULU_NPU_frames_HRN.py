...
class FASDataset_OULU_NPU_frames_HRN(Dataset):
    ...
    def __init__(self, root_dir, protocol_id, frames_path, images_file, transform, smoothing, 
        ...
        # self.ids = [file[:file.rfind('_')] for file in self.filenames]   # original
        self.ids = [file[:file.rfind('_frame')] for file in self.filenames]     # Bernardo
    ...
    def __getitem__(self, index):
        ...
        # print('cloud_map_normalized.shape:', cloud_map_normalized.shape)
